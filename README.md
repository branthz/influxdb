# InfluxDB [![Circle CI](https://circleci.com/gh/branthz/influxdb/tree/master.svg?style=svg)](https://circleci.com/gh/branthz/influxdb/tree/master) [![Go Report Card](https://goreportcard.com/badge/github.com/branthz/influxdb)](https://goreportcard.com/report/github.com/branthz/influxdb) [![Docker pulls](https://img.shields.io/docker/pulls/library/influxdb.svg)](https://hub.docker.com/_/influxdb/)
...
If you're feeling adventurous and want to contribute to InfluxDB, see our [contributing doc](https://github.com/branthz/influxdb/blob/master/CONTRIBUTING.md) for info on how to make feature requests, build from source, and run tests.
